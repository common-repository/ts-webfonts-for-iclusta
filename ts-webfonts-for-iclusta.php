<?php
/*
Plugin Name: TS Webfonts for iCLUSTA+
Version: 2.0.6
Description: iCLUSTA+レンタルサーバーで株式会社モリサワが提供する33書体のWebフォントを無料で利用できるプラグインです。
Author: GMO GlobalSign Holdings K.K.
Author URI: https://shared.gmocloud.com/
Plugin URI: https://wordpress.org/plugins/ts-webfonts-for-iclusta/
...
class TypeSquare_ST
{
    ...
    public function load_scripts()
    {
        ...
        if (false !== $uid) {
            wp_register_script('typesquare_std', "//code.typesquare.com/static/607e2ce8d9e44b2fa91528b7ac1e02d5/ts307f.js?$query", array( 'jquery' ), $version, false);
